...
public class CustomAdapterBookingList extends RecyclerView.Adapter<CustomAdapterBookingList.MyViewHolder> {
    ...
    public CustomAdapterBookingList(ArrayList<TurfBookingModel> data, Context context) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_turfs_bookings, parent, false);
...
//        UserModel userModel = databaseHelper.getUser(userId,isowner);
        ...
        if(approve_status == 0 )
        {
            textViewStatus.setText("Not Approved Yet");
